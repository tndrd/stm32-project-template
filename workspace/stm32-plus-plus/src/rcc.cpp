...
/////////////////*************
  ...
  if(mHseValue==16000000)
    // ��� HSE 14.7456 ���, ����� �������� SYSCLK = 72 ���, ��������� PLL ������ ���� 14\3 (PLLMUL x 5)
  ...
  RCC->CFGR &= ~RCC_CFGR_PPRE1; // APB1 prescaler = 2 (36 ��� �������� ��� APB1)
  RCC->CFGR |= RCC_CFGR_PPRE1_DIV2;
...
/////////////////*************
  ...
  // ��������� ��������� AHB, APB1 � APB2
  RCC->CFGR &= ~RCC_CFGR_HPRE; // AHB prescaler = 1
  RCC->CFGR &= ~RCC_CFGR_PPRE; // APB1 prescaler = 2 (36 ��� �������� ��� APB1)
